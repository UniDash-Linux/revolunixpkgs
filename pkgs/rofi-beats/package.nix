...
stdenv.mkDerivation (finalAttrs: {
  pname = "exemple";
  version = "nightly-2024.06.18-11.06.17";
  ## ----------------------------------------------------------------- ##
  src = fetchurl {
    url = "https://github.com/RevoluNix/pkg-rofi-beats/releases/download/nightly-2024.06.18-11.06.17/src-rofi-beats.tar.gz";
    sha256 = "13c2018a11ab106285faa9ac045eba1cd2783d27c6d07ef0dc573931cf443f3b";
  }; 
  ## ----------------------------------------------------------------- ##
