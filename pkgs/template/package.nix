...
stdenv.mkDerivation (finalAttrs: {
  pname = "exemple";
  version = "testing-2024.06.24-09.33.45";
  ## ----------------------------------------------------------------- ##
  src = fetchurl {
    url = "https://github.com/RevoluNix/pkg-template/releases/download/testing-2024.06.24-09.33.45/src-template.tar.gz";
    sha256 = "13501075ac42ba2b63169b26f176acfe98b0343a71b6e656a9bd4ffd23c2b176";
  }; 
  ## ----------------------------------------------------------------- ##
