...
stdenv.mkDerivation (finalAttrs: {
  pname = "exemple";
  version = "nightly-2024.06.18-22.13.45";
  ## ----------------------------------------------------------------- ##
  src = fetchurl {
    url = "https://github.com/RevoluNix/pkg-rofi-power/releases/download/nightly-2024.06.18-22.13.45/src-rofi-power.tar.gz";
    sha256 = "cf5a419366b3793ff4d045367e3030cdf2f46fa9b506eb461f29160323ef02ef";
  }; 
  ## ----------------------------------------------------------------- ##
