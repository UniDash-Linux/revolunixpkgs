...
stdenv.mkDerivation (finalAttrs: {
  pname = "exemple";
  version = "release-2024.06.17-17.52.48";
  ## ----------------------------------------------------------------- ##
  src = fetchurl {
    url = "https://github.com/RevoluNix/pkg-focus-rofi/releases/download/release-2024.06.17-17.52.48/src-focus-rofi.tar.gz";
    sha256 = "88f002c8358f91316cc30e2b6ddd3881538f73bedf6a0e3d6747efb09d926117";
  }; 
  ## ----------------------------------------------------------------- ##
