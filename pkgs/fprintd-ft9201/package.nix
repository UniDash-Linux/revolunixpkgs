...
let
  ...
  ft9201-rules = fetchurl {
    url = "https://raw.githubusercontent.com/RevoluNix/ft9201-static/main/pkg/opt/libfprint/lib/udev/rules.d/60-libfprint-2.rules";
    sha256 = "e642bec3c87efe1bfd7dad664ff35b2603b88fb66225e6075516c4c09562216c";
  };
  ...
  libfprint-ft9201 = stdenv.mkDerivation rec {
    ...
    preFixup =
      ...
      ''
        ...
        cp ${ft9201-rules} $out/lib/udev/rules.d/60-libfprint-2.rules
